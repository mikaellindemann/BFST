...
public class GUI extends JComponent {
    ...
    public void gui() throws IOException {
        ...
        buttonUp.getInputMap(buttonUp.WHEN_IN_FOCUSED_WINDOW).put(KeyStroke.getKeyStroke(KeyEvent.VK_UP, 0), "buttonUp");
        ...
        //Add keybind function
        buttonLeft.getInputMap(buttonLeft.WHEN_IN_FOCUSED_WINDOW).put(KeyStroke.getKeyStroke(KeyEvent.VK_LEFT, 0), "buttonLeft");
        ...
        //Add keybind function
        buttonRight.getInputMap(buttonRight.WHEN_IN_FOCUSED_WINDOW).put(KeyStroke.getKeyStroke(KeyEvent.VK_RIGHT, 0), "buttonRight");
        ...
        //Add keybind function
        buttonDown.getInputMap(buttonDown.WHEN_IN_FOCUSED_WINDOW).put(KeyStroke.getKeyStroke(KeyEvent.VK_DOWN, 0), "buttonDown");
        ...
        //Add keybind function
        buttonZoomIn.getInputMap(buttonZoomIn.WHEN_IN_FOCUSED_WINDOW).put(KeyStroke.getKeyStroke(KeyEvent.VK_PLUS, 0), "buttonZoomIn");
        ...
        //Add keybind function
        buttonZoomOut.getInputMap(buttonZoomOut.WHEN_IN_FOCUSED_WINDOW).put(KeyStroke.getKeyStroke(KeyEvent.VK_MINUS, 0), "buttonZoomOut");
