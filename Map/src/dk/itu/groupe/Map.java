...
public class Map extends JComponent
{
	...
	public Map() throws IOException
	{
		...
		for (NodeData nd : nodes)
		{
			if (nd.X_COORD < xlow) xlow = (int) nd.X_COORD;
			if (nd.X_COORD > xhigh) xhigh = (int) nd.X_COORD;
			if (nd.Y_COORD < ylow) ylow = (int) nd.Y_COORD;
			if (nd.Y_COORD > yhigh) yhigh = (int) nd.Y_COORD;
		}
